...
@Component({
  selector: 'app-my-projects-backend',
  standalone: true,
  imports: [CommonModule, TranslatePipe],
  templateUrl: './my-projects-backend.component.html',
  styleUrls: ['./my-projects-backend.component.scss'],
})
export class MyProjectsBackendComponent {
